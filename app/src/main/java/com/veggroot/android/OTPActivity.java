...
public class OTPActivity extends AppCompatActivity {
    ...
    PinView pinView;
    TextView sendOTp, verifyNumber, otpDesc, verifyDesc, mResendButton;
    EditText mPhoneNumberField;
    Button continueButton, mVerifyButton;
    // [START declare_auth]
    ...
    private void setViews() {
        ...
        sendOTp=findViewById(R.id.sendOTPTextView);
        verifyNumber=findViewById(R.id.verifyTextView);
